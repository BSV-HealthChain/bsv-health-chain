...
export const useWallet = () => useContext(WalletContext); it is not connecting to Metanet Wallet. Use the same logic const desktopWallet = new WalletClient() as WalletClientExtended; for the Metanet Wallet connection, it works.
